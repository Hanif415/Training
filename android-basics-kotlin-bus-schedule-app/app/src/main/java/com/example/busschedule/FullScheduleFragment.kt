...
class FullScheduleFragment : Fragment() {
    ...
    // get the view model instance through application class
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val busStopAdapter = BusStopAdapter {
            // add action move to another navigation as the argument
            val action =
                FullScheduleFragmentDirections.actionFullScheduleFragmentToStopScheduleFragment(
                    // put the stop name as argument value from argument lambda in adapter
        ...
        // submit the adapter and put the data from view model
